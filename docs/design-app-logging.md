...
| `android/app/src/main/kotlin/.../MainActivity.kt` | 新增 `com.openbuilder.app/files` 通道 + `saveToDownloads`：`MediaStore.Downloads`（API 29+，无权限）/ 旧 API 直接复制到公共 Download 目录 |
